...
//-------------------------------------------------------------------
	@Test
	public void testeIncrementaFomeVivo() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		LoboGuara lobo = new LoboGuara(false, new Campo(50,50), new Localizacao(1,1));
		Method incrementaFome = lobo.getClass().getDeclaredMethod("incrementaFome");
		incrementaFome.setAccessible(true);
		for(int i=0; i < 5; i++) {
...
//--------------------------------------------------------------------------
	@Test
	public void testeSetLocalizacao() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
...
//--------------------------------------------------------------------------
	@Test
	public void testeProcuraComidaFalse() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Localizacao localizacao = new Localizacao(1,1);
		Campo campo = new Campo(50,50);
		LoboGuara lobo = new LoboGuara(false, campo , localizacao);
...
//--------------------------------------------------------------------------	
	@Test
	public void testeProcuraComidaTrue() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Localizacao localizacao = new Localizacao(1,1);
		Campo campo = new Campo(50,50);
		LoboGuara lobo = new LoboGuara(false, campo , localizacao);
...
//--------------------------------------------------------------------------
	@Test
	public void testeCacaComOvelha() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		Localizacao localizacao = new Localizacao(1,1);
		Campo campo = new Campo(50,50);
		LoboGuara lobo = new LoboGuara(false, campo , localizacao);
...
//--------------------------------------------------------------------------
	@Test
	public void testeCacaSemOvelha() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		Localizacao localizacao = new Localizacao(1,1);
		Campo campo = new Campo(50,50);
		LoboGuara lobo = new LoboGuara(false, campo , localizacao);
		lobo.caca(new ArrayList<LoboGuara>());
...
//--------------------------------------------------------------------------	
	@Test
	public void testeCacaSemOvelhaAteAMorte() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
		Localizacao localizacao = new Localizacao(1,1);
		Campo campo = new Campo(50,50);
		LoboGuara lobo = new LoboGuara(false, campo , localizacao);
		for(int i = 0; i< 7; i++)
